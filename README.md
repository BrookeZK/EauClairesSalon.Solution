...
5. Enter `USE Jonathan_Carlos;` to connect to the database. You can confirm that you have connected to your new database by executing the `SELECT DATABASE();` command.
